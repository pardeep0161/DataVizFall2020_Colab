                      ...
                      )
{
    ...
    rScale= d3.scaleLinear().domain(d3.extent(data,function (d){return d.r})).range([2,10])
    ...
    markers.enter().append('g') //append new circles
        ...
        .on("mouseenter",function (){
            ...
            d3.selectAll(`circle`).classed("highlighted",false).attr("r",function (d){return rScale(d.r)})
            d3.selectAll(`.${mouse_selected_element_class}`)
                .classed("highlighted",true)
                .transition().duration(1000)
                .ease(d3.easeBounceOut)
                .attr("r",function (d){return rScale(d.r)*4})
